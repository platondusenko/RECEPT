async function getRecipe() {
  ...
  document.getElementById('recept').innerHTML = `
    ...
    <img style="border-radius: 12px;  margin-right: 20px; height: 300px; float: left; width: 400px; box-shadow: 0 2px 4px rgba(79, 70, 229, 0.2);" src="${recipe.strMealThumb}" width="300" height="200" alt="${recipe.strMeal}">
    <ul style="color: #0F4C81; margin-left: 20px; float: left;  margin-top: 5px; ">
      ${Array.from({ length: 20 }, (_, i) => {
        ...
        return '';
          ...
          <p style="color: #0F4C81; margin-top: 20px; padding-left: 50px; float: left;  "> <h4 > 👨‍🍳 Поради щодо приготування </h4>
